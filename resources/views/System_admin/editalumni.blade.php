                            ...
                            <div class="col-sm-8">
                                <div class="card" style="width: 6.2in;">
                                    <div class="card-header  bg-c-pink text-white">
                                        <h4 class="text-white m-b-20">Update Alumni Record</h4>
                                            ...
                                            <form action="/alumni_records/{{$alumni_records->id}}" method="POST"
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    ...
                                                    <input type="text" class="form-control" id="first_name"
                                                        ...
                                                        value="{{$alumni_records->first_name}}">
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    <input type="text" class="form-control" id="middle_name"
                                                        ...
                                                        value="{{$alumni_records->middle_name}}">
                                                    <span class="text-danger">@error('middle_name') {{$message}}
                                                        @enderror</span>
                                                </div>
                                                <div class="mb-3" style="width: 3in;">
                                                    <input type="text" class="form-control" id="last_name"
                                                        name="last_name" placeholder="Last Name"
                                                        value="{{$alumni_records->last_name}}">
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    ...
                                                    <select class="form-select" name="gender" id="gender" role="button">
                                                        <option value="{{$alumni_records->gender}}" selected>
                                                            {{$alumni_records->gender}}</option>
                                                ...
                                                <div class="mb-3" style="width: 4.5in;">
                                                    ...
                                                    <input type="text" class="form-control" id="home_address"
                                                        ...
                                                        value="{{$alumni_records->home_address}}">
                                                    <span class="text-danger">@error('home_address') {{$message}}
                                                        @enderror</span>
                                                </div>
                                                <div class="mb-3" style="width: 4.5in;">
                                                    <input type="text" class="form-control" id="present_address"
                                                        name="present_address" placeholder="Present Address"
                                                        value="{{$alumni_records->present_address}}">
                                                    <span class="text-danger">@error('present_address') {{$message}}
                                                        @enderror</span>
                                                </div>
                                                <!-- Addresses -->
                                                ...
                                                <!-- School Graduated -->
                                                <div class="mb-3" style="width: 3in;">
                                                    <label for="school_graduated" class="form-label">School
                                                        Graduated</label>
                                                    <input type="text" class="form-control" id="school_graduated"
                                                        name="school_graduated" placeholder="School Graduated"
                                                        value="{{$alumni_records->school_graduated}}">
                                                    <span class="text-danger">@error('school_graduated') {{$message}}
                                                        @enderror</span>
                                                </div>
                                                <!-- School Graduated -->
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    ...
                                                    <input type="number" class="form-control" id="batch_no"
                                                        name="batch_no" value="{{$alumni_records->batch_no}}">
                                                    <span class="text-danger">@error('batch_no') {{$message}}
                                                        @enderror</span>
                                                </div>
                                                <!-- Batch No -->
                                                ...
                                                function EnableDisableTextBoxByEmploymentStatus(employment_status) {
                                                    job_title.disabled = employment_status.value === 'Unemployed' ?
                                                        true : false;
                                                    company_name.disabled = employment_status.value === 'Unemployed' ?
                                                        true : false;
                                                    company_location.disabled = employment_status.value ===
                                                        'Unemployed' ? true : false;
                                                    work_arrangement.disabled = employment_status.value ===
                                                        'Unemployed' ? true : false;
                                                    date_hired.disabled = employment_status.value === 'Unemployed' ?
                                                        true : false;
                                                }
                                                </script>
                                                <!-- SCRIPT FOR EMPLOYMENT STATUS -->
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    ...
                                                    <select class="form-select" name="employment_status"
                                                        ...
                                                        value="{{$alumni_records->employment_status}}">
                                                        <option value="">None</option>
                                                        <option value="Employed">Employed</option>
                                                        <option value="Unemployed">Unemployed</option>
                                                        <option value="{{$alumni_records->employment_status}}" selected
                                                            hidden>{{$alumni_records->employment_status}}</option>
                                                    </select>
                                                    @else
                                                    <select class="form-select" name="employment_status"
                                                        id="employment_status" role="button"
                                                ...
                                                <div class="mb-3" style="width: 4.5in;">
                                                    <input type="text" class="form-control" id="job_title"
                                                        ...
                                                        value="{{$alumni_records->job_title}}">
                                                ...
                                                <div class="mb-3" style="width: 4.5in;">
                                                    <input type="text" class="form-control" id="company_name"
                                                        ...
                                                        value="{{$alumni_records->company_name}}">
                                                ...
                                                <div class="mb-3" style="width: 4.5in;">
                                                    <input type="text" class="form-control" id="company_location"
                                                        ...
                                                        value="{{$alumni_records->company_location}}">
                                                    <span class="text-danger">@error('company_location') {{$message}}
                                                        @enderror</span>
                                                </div>
                                                <div class="mb-3" style="width: 4.5in;">
                                                    <input type="date" class="form-control" id="date_hired"
                                                        name="date_hired" placeholder="Date Hired"
                                                        value="{{$alumni_records->date_hired}}">
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    <select class="form-select" name="work_arrangement"
                                                        ...
                                                        value="{{$alumni_records->work_arrangement}}">
                                                        <option value="Full-time">Full-time</option>
                                                        <option value="Part-time">Part-time</option>
                                                        <option value="Flextime">Flextime</option>
                                                        <option value="Trainee">Trainee</option>
                                                        <option value="{{$alumni_records->work_arrangement}}" selected
                                                            hidden>{{$alumni_records->work_arrangement}}</option>
                                                    </select>
