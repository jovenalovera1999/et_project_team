        ...
        <div class="wrapper d-flex align-items-stretch">
            <nav id="sidebar">
                ...
                <div class="p-4">
                    ...
                    <h1><a href="index.html" class="logo ">Menu<span class="text-white">Admin: </span></a></h1>
                    <br>
                                    ...
                                    <div class="card" style="width: 6.2in;">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-7" style="margin-left: 30px">
                                                <form action="/alumni_records" method="POST" class="mt-3">
                                                    @csrf
                                                    ...
                                                    <div class="mb-3" style="width: 3in;">
                                                        ...
                                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="{{old('name')}}">
                                                        <span class="text-danger">@error('first_name') {{$message}} @enderror</span>
                                                    </div>
                                                    <div class="mb-3" style="width: 3in;">
                                                        <input type="text" class="form-control" id="middle_name" name="middle_name" placeholder="Middle Name" value="{{old('name')}}">
                                                        <span class="text-danger">@error('middle_name') {{$message}} @enderror</span>
                                                    </div>
                                                    <div class="mb-3" style="width: 3in;">
                                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="{{old('name')}}">
                                                    ...
                                                    <div class="mb-3" style="width: 3in;">
                                                        ...
                                                        <input type="text" class="form-control" id="school_graduated" name="school_graduated" placeholder="School Graduated">
                                                    ...
                                                    <div>
                                                        <script type="text/javascript">
                                                            function EnableDisableTextBox(checkBox) {
                                                                employment_status.disabled = checkBox.checked ? true : false;
                                                                if (!employment_status.disabled) {}
                                                                job_title.disabled = checkBox.checked ? true : false;
                                                                if (!job_title.disabled) {}
                                                                company_name.disabled = checkBox.checked ? true : false;
                                                                if (!company_name.disabled) {}
                                                                company_location.disabled = checkBox.checked ? true : false;
                                                                if (!company_location.disabled) {}
                                                                work_arrangement.disabled = checkBox.checked ? true : false;
                                                    ...
                                                    <div class="mb-3" style="width: 3in;">
                                                        <select class="form-select" name="work_arrangement" id="work_arrangement" role="button">
                                                            <option selected>Work Arrangement</option>
                                                            <option value="Employed">Employed</option>
                                                            <option value="Unemployed">Unemployed</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="mb-3" style="width: 3in;">
                                                        ...
                                                        <select class="form-select" name="scholarship_sponsors" id="scholarship_sponsors" role="button">
