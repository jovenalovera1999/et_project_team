                                ...
                                <div class="card" style="width: 6.2in;">
                                    <div class="card-header  bg-c-pink text-white">
                                        ...
                                        <div class="float-right">
                                            <a href="/alumni_records" type="button"
                                                class="btn profile_button2 text-light">
                                                <span class="fa fa-eye  mr-3" style="color:light"></span>View Alumni
                                                Record
                                            </a>
                                        </div>
                                    </div>
                                            ...
                                            <form action="/alumni_records" method="POST" class="mt-3">
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    ...
                                                    <select class="form-select" name="scholarship_sponsor"
                                                        ...
                                                        <option value="{{$scholarship_sponsor->sponsor}}">
                                                            {{$scholarship_sponsor->sponsor}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    <input type="password" class="form-control" id="password"
                                                        name="password" placeholder="Input user's password"
                                                        value="{{old('password')}}">
