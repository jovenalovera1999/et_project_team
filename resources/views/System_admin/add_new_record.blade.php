                                        ...
                                        <div class="col-sm-7" style="margin-left: 30px">
                                            <form action="/alumni_records" method="POST" class="mt-3">
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    ...
                                                    <input type="number" class="form-control" id="contact" name="contact" placeholder="Contact Number" value="{{old('contact')}}">
                                                ...
                                                <div class="mb-3" style="width: 4.5in;">
                                                    <input type="text" class="form-control" id="present_address" name="present_address" placeholder="Present Address" value="{{old('present_address')}}">
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    ...
                                                    <input type="text" class="form-control" id="school_graduated" name="school_graduated" placeholder="School Graduated" value="{{old('school_graduated')}}">
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    ...
                                                    <input type="number" class="form-control" id="batch_no" name="batch_no" value="{{old('batch_no')}}">
                                                ...
                                                <div class="mb-3" style="width: 3in;">
                                                    <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm password" value="{{old('confirm-password')}}">
