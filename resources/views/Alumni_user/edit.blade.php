                                            ...
                                            <span class="text-danger">@error('first_name') {{$message}} @enderror</span>
                                                    ...
                                                    <div class="mb-3" style="width: 3in;">
                                                        ...
                                                        <select class="form-select" name="gender" id="gender" role="button">
                                                            <option selected>{{ ucfirst($alumni_user1 -> gender) }}</option>
                                                    ...
                                                    <div class="mb-3" style="width: 4.5in;">
                                                        <label for="home_address" class="form-label">Present Address</label>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" id="pending_offer" name="pending_offer" value="check" onclick="EnableDisableTextBox(this)"/>
                                                        <label for="pending offer">Have pending offers?</label>
                                                    ...
                                                    <div class="mb-3" style="width: 4.5in;">
                                                        <label for="employment_status" class="form-label">Company Location</label> <br />
                                                    ...
                                                    <div class="mb-3" style="width: 3in;">
                                                        ...
                                                        <select class="form-select" name="work_arrangement" id="work_arrangement" role="button">
                                                            <option selected>{{ ucfirst($alumni_user1 -> work_arrangement) }}</option>
                                                            <option value="Employed">Employed</option>
                                                            <option value="Unemployed">Unemployed</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <!--<div class="mb-3" style="width: 3in;">
                                                        ...
                                                        <select class="form-select" name="user_type" id="user_type" role="button">
                                                            <option selected>{{ ucfirst(Auth::user() -> user_type) }} </option>
